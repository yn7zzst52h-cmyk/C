...
/// a)
///
/// Escreva uma função 'escVetor' para escrever um vetor de carateres v
/// (de n elementos) separados por um espaço.

void escVetor(char v[], int n) {
    for(int i = 0; i < n; i++) {
        printf("%c ", v[i]);
    }
    printf("\n");
...
int main()
{
    ...
    /// entre as 8 equipas constantes do vetor v acima
